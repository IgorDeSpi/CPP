...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/03/29 16:49:35 by ide-spir          #+#    #+#             */
/*   Updated: 2023/03/29 17:25:14 by ide-spir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	if (argc != 4)
	{
		std::cout << "Wrong number of arguments - Need 3 args (Filename, string researched and string for replace)" << std::endl;
		return (0);
	}
